    ...
    <div style="margin:0px auto;max-width:600px;">
      <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width:100%;">
        <tbody>
              ...
              <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                  <tbody>
                    ...
                    <tr>
                      <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        <div style="font-family:Roboto;font-size:14px;line-height:1;text-align:left;color:#000000;">You just created an account on stackmemento.com.</div>
                      </td>
                    </tr>
                    <tr>
                      <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                    ...
                    <tr>
                      <td align="center" vertical-align="middle" style="font-size:0px;padding:10px 25px;padding-bottom:5px;word-break:break-word;">
          ...
          <a href="https://google.com" font-style="italic">
            https://stackmemento.com/?validate_registration=2cf24dba5fb0a30e26e83b2ac5b9e29e1b161e5c1fa7425e73043362938b9824
          </a>
        </mj-text> -->
                    <tr>
                      <td style="font-size:0px;word-break:break-word;">
                    ...
                    <tr>
                      <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        <div style="font-family:Roboto;font-size:12px;font-style:italic;line-height:1;text-align:left;color:#000000;">Note that the provided link is only valid for 2 hours. Past this delay, try login with your registered credential to receive another validation e-mail</div>
                      </td>
                    </tr>
                    <tr>
                      <td style="font-size:0px;word-break:break-word;">
                    ...
                    <tr>
                      <td align="right" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        <div style="font-family:Roboto;font-size:14px;line-height:1;text-align:right;color:#000000;">Respectfully</div>
                      </td>
                    </tr>
                    <tr>
                      <td align="right" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        <div style="font-family:Roboto;font-size:14px;font-weight:bold;line-height:1;text-align:right;color:#000000;">Stackmemento's dev</div>
                      </td>
                    </tr>
                  </tbody>
                </table>
